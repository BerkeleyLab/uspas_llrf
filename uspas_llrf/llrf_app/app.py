...
class LLRFApp(LEEPDevice):
    def __init__(self, addr='192.168.19.42:803', conf='LEMP',
        ...
        # self.init_open_loop_demo()

    def init_open_loop_demo(self, open_loop_dac_amp=20000):
        open_loop_amp_sp = 2e4 / self.model.cal_factors.tx_gain
        assert open_loop_amp_sp < self.model.cal_factors.max_amp_setpoint
        self.reg_write([
